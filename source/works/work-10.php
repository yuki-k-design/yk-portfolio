    ...
    <div class="container-fluid p-0 flex-wrap fadeUpTrigger">
      <div class="row">
        <div class="col-12 col-lg-4 pb-5">
          <h3 class="pb-3">Webサイトのデザイン改修</h3>
          <p class="m-0">制作期間：約3週間</p>
          <p class="">担当：デザイン作成</p>
          <a href="https://biz.nissan.co.jp/" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-arrow-up-right-from-square pr-2"></i>show website</a>
        </div>
        <div class="col-12 col-lg-8 pb-5">
          <img src="../img/work-nissan02-lg.png" class="img-fluid" alt="制作実績画像">
        </div>
      </div>
    </div>
  </section>
