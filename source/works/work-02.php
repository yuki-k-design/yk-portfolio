    ...
    <div class="container-fluid p-0 flex-wrap fadeUpTrigger">
      <div class="row">
        <div class="col-12 col-lg-4 pb-5">
          ...
          <a href="https://seminar.kabutan.jp/op/02/" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-arrow-up-right-from-square pr-2"></i>show website</a>
        </div>
        <div class="col-12 col-lg-8 pb-5">
          <img src="../img/work-kabutan02-lg.png" class="img-fluid" alt="制作実績画像">
        </div>
      </div>
    </div>
  </section>
